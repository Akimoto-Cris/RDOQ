...
default_cfgs = {
    ...
    # changed to mae url
    'vit_large_patch16_224': _cfg('https://dl.fbaipublicfiles.com/mae/finetune/mae_finetuned_vit_large.pth'),
    'vit_large_patch16_384': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'L_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.1-sd_0.1--imagenet2012-steps_20k-lr_0.01-res_384.npz',
        input_size=(3, 384, 384), crop_pct=1.0),
    # added mae url
    'vit_huge_patch14_224': _cfg(url='https://dl.fbaipublicfiles.com/mae/finetune/mae_finetuned_vit_huge.pth'),
